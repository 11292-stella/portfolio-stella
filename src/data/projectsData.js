export const progetti = [
  {
    ...
    descrizione: "App per allenarsi di nascosto durante il lavoro. Frontend React, backend Spring Boot.",
  ...
  },
  {
    ...
    categoria: "fullstack",
    titolo: "Impizza",
    descrizione: "Gestione ordini per pizzeria: interfaccia cliente e dashboard admin. Angular + Spring Boot.",
  ...
  },
  {
    ...
    descrizione: "Mini-gioco a tema Halloween con React, TypeScript e Vite. Un'esperienza spettrale e divertente.",
  ...
  },
  {
    ...
    categoria: "frontend",
    titolo: "DevGuide",
    descrizione: "Guida pratica per ripassare concetti chiave dello sviluppo web. Leggera, utile e ironica.",
    immagine: "/pp.png",
  ...
  },
  {
    ...
    categoria: "frontend",
    titolo: "Music Play",
    descrizione: "Web app frontend con focus sulla gestione dello stato tramite Redux.",
    immagine: "/2p.png",
  ...
  },
  {
    ...
    descrizione: "Web app meteo in tempo reale con chiamate API e gestione dello stato.",
    immagine: "/3p.png",
  ...
  },
  {
    ...
    descrizione: "Vetrina digitale dedicata ai libri dell'orrore. HTML, CSS e un pizzico di JavaScript.",
    immagine: "/4p.png",
  ...
  },
  {
    ...
    descrizione: "Web app ispirata a Netflix con React e chiamate API per esplorare design e interfaccia.",
    immagine: "/5p.png",
    tecnologie: "React, Bootstrap, APIs",
  ...
  },
  {
    ...
    descrizione: "Sito vetrina per un ristorante immaginario ispirato ai cartoni animati.",
    immagine: "/p6.png",
  ...
  },
  {
    ...
    descrizione: "Primo esperimento con animazioni CSS: transizioni, trasformazioni e piccoli effetti dinamici.",
    immagine: "/7p.png",
  ...
  },
  {
    ...
    descrizione: "Primo progetto JavaScript: interazioni, logica e piccoli script per rendere la pagina dinamica.",
    immagine: "/8p.png",
    tecnologie: "HTML5, CSS3, JavaScript",
  ...
  },
  {
    ...
    descrizione: "Backend completo per la creazione e gestione di itinerari turistici.",
  ...
  },
  {
    ...
    descrizione: "Sistema backend per creare eventi e gestire prenotazioni utente.",
  ...
  },
  {
    ...
    descrizione: "Backend full stack per creare schede allenamento e gestire utenti.",
  ...
  },
  {
    ...
    descrizione: "Backend per gestione ordini pizzeria con autenticazione JWT e API REST.",
  ...
  },
  {
    ...
    descrizione: "App Flutter per creare e gestire liste della spesa, chat e mappe.",
  ...
  },
  {
    ...
    descrizione: "App Flutter con quiz a scelta multipla e feedback visivo finale.",
  ...
  },
  {
    ...
    descrizione: "App Flutter con finestrelle interattive che narrano tradizioni natalizie da tutto il mondo.",
  ...
  },
  {
    ...
    categoria: "flutter",
    titolo: "Cooking App",
    descrizione: "App Flutter con categorie di cucina, ricette dettagliate e lista ingredienti.",
  ...
  },
  {
    ...
    descrizione: "App Flutter per gestire entrate e uscite, con grafici e analisi delle spese.",
...
export const fullstackProjects = progetti.filter((p) => p.categoria === "fullstack")
export const frontendProjects = progetti.filter((p) => p.categoria === "frontend")
export const backendProjects  = progetti.filter((p) => p.categoria === "backend")
export const flutterProjects  = progetti.filter((p) => p.categoria === "flutter")
